<template>
  <div class="inline-flex flex-col select-none shadow-md rounded-lg">
    <div
      class="rounded-t-lg flex items-center justify-center dark_bg-primary dark_text-white dark_hover_bg-primary-dark duration-150 cursor-pointer bg-white text-primary w-[33px] h-[33px] hover_bg-gray-200"
      :class="{ 'cursor-not-allowed': disabledIn }"
      @click="$emit('change', disabledIn ? 0 : 1)"
    >
    ...
    <div
      class="rounded-b-lg flex items-center justify-center dark_bg-primary dark_text-white dark_hover_bg-primary-dark duration-150 cursor-pointer bg-white text-primary w-[33px] h-[33px] hover_bg-gray-200"
      :class="{ 'cursor-not-allowed': disabledOut }"
      @click="$emit('change', disabledOut ? 0 : -1)"
    >
