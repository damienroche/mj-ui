<template>
  <div class="inline-flex flex-col select-none shadow-md rounded-lg">
    <div
      class="rounded-t-lg flex items-center justify-center dark_bg-navy dark_text-white dark_hover_bg-navy-dark animation duration-150 cursor-pointer bg-white text-navy w-[33px] h-[33px] hover_bg-gray-200"
    ...
    <div
      class="rounded-b-lg flex items-center justify-center dark_bg-navy dark_text-white dark_hover_bg-navy-dark animation duration-150 cursor-pointer bg-white text-navy w-[33px] h-[33px] hover_bg-gray-200"
