<template>
  <div class="inline-flex flex-col select-none shadow-md rounded-lg">
    <div
      class="rounded-t-lg flex items-center justify-center bg-navy text-white hover_bg-navy-dark animation duration-150 cursor-pointer dark_bg-white dark_text-navy w-[33px] h-[33px] dark_hover_bg-gray-200"
    ...
    <div
      class="rounded-b-lg flex items-center justify-center bg-navy text-white hover_bg-navy-dark animation duration-150 cursor-pointer dark_bg-white dark_text-navy w-[33px] h-[33px] dark_hover_bg-gray-200"
