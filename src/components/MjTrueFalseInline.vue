<template>
  <div class="flex items-center gap-4 bg-gray-100 dark_bg-dark-100 py-4 pl-4 pr-2 rounded">
...
import MjTrueFalseToggle from './MjTrueFalseToggle.vue';
...
export default {
  ...
  components: {
    ...
    'mj-true-false-toggle': MjTrueFalseToggle,
    'mj-text': MjText
  },
  props: {
    /**
